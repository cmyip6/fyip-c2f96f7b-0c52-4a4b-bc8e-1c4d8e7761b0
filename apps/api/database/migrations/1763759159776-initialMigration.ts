...
export class InitialMigration1763759159776 implements MigrationInterface {
    name = 'InitialMigration1763759159776'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "TASKS" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by" character varying, "updated_by" character varying, "id" SERIAL NOT NULL, "TITLE" character varying(50) NOT NULL, "DESCRIPTION" json, "STATUS" character varying NOT NULL DEFAULT 'OPEN', "DELETED_AT" TIMESTAMP, "DELETED_BY" character varying, "USER_ID" uuid NOT NULL, CONSTRAINT "PK_d1bd6713abd1e91ee9512056cc0" PRIMARY KEY ("id"))`);
